...
#define outputPin  15
#define zerocross  33 // for boards with CHANGEBLE input pins
...
void setup() {
  ...
  USE_SERIAL.println("Set value");
    pinMode(zerocross, INPUT_PULLUP);  // ?? pullup?
...
void loop() {
  ...
  outVal = map(analogRead(A0), 0,4095, 1,96);
